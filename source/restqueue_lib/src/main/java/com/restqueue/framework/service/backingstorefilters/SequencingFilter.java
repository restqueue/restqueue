...
public class SequencingFilter implements BackingStoreFilter{
    ...
    static{
        sequenceStrategyFilters.put(SequenceStrategy.SINGLE, new SingleSequencingFilter());
        sequenceStrategyFilters.put(SequenceStrategy.GROUPED, new GroupedSequencingFilter());
    }
